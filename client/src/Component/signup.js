...
export default class Signup extends Component {
	...
	state = { nomR: "", prenomR: "", emailR: "", passwordR: "", dateR:"", signup:false };
    handleChange = e => {
      this.setState({
    ...
    register = () => {
        ...
        const { nomR, prenomR, emailR, passwordR,dateR } = this.state;
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <div className="form-group">
                                        <label for="username" className="cols-sm-2 control-label">First Name</label>
                                        <div className="cols-sm-10">
                                            <div className="input-group">
                                                <span className="input-group-addon"><i className="fa fa-users fa" aria-hidden="true"></i></span>
                                                <input type="text" className="form-control" name="nomR" onChange={this.handleChange} placeholder="Enter your Username" />
                                            </div>
                                        </div>
                                    </div>
									<div className="form-group">
                                        <label for="username" className="cols-sm-2 control-label">Familly Name</label>
                                        <div className="cols-sm-10">
                                            <div className="input-group">
                                                <span className="input-group-addon"><i className="fa fa-users fa" aria-hidden="true"></i></span>
                                                <input type="text" className="form-control" name="prenomR" onChange={this.handleChange} placeholder="Enter your Username" />
                                            </div>
                                        </div>
                                    </div>
